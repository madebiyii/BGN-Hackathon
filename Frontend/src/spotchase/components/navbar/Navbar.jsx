      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="items-center justify-center gap-7 py-10 sm:mt-0 sm:flex md:py-10">
          ...
          <div className="ml-auto flex justify-center gap-2 sm:mt-8 sm:justify-end md:mt-7">
            ...
            {/* Show Join Beta Access unless on Preferences or ShareItinerary page */}
            {props.page !== "Preferences" && props.page !== "ShareItinerary" ? (
              <Link href="/signup">
                <div
                  className={`cursor-pointer rounded-xl ${
                    color === "white"
              ...
              <>
                {/* Show Set Preferences only if NOT already on preferences */}
                {props.page !== "Preferences" && (
                  <Link href="/preferences">
                    <div
                      className={`cursor-pointer rounded-xl ${
