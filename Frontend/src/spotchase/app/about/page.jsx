...
//             >
//               Welcome to SpotChase, the ultimate app for adventurers and explorers! At SpotChase, we believe every journey is a story waiting to be written. Whether you're discovering new destinations, chasing hidden gems, or meeting fellow travelers, SpotChase is here to guide your adventures. We’re passionate about connecting people with the places and experiences that matter most, and we strive to make every journey memorable.
//             </p>
//             <p
//               data-cy="about-text2"
//               className="text-md pt-5 text-left text-gray-600 lg:text-xl"
//             >
//               SpotChase was created by passionate explorers who believe technology can enhance how we experience the world. Our founders,{" "}
//               <a
//                 data-cy="about-link1"
...
//                 data-cy="about-link2"
//                 className="text-blue-600"
//                 href="https://www.linkedin.com/in/michael-adebiyii/"
//               >
//                 {" "}
//                 Michael Adebiyi{" "}
//               </a>{" "}
//               embarked on a mission to merge their love for travel with cutting-edge technology. They saw a gap in how people explore new places and share their experiences, and SpotChase was born—an app designed to inspire your next adventure.
//             </p>
//             <Features />
//           </div>
//         </div>
...
//       description:
//         "SpotChase integrates an advanced mapping system that allows users to explore new destinations seamlessly. With real-time navigation and location-based suggestions, SpotChase helps you discover hidden gems, local favorites, and off-the-beaten-path adventures.",
//       id: "interactive-maps",
//     },
//     {
